  ...
  - main [ref=e31]:
    - generic [ref=e32]:
      ...
      - generic [ref=e41]:
        ...
        - iframe [ref=e70]:
          - article "Server Not Found" [ref=f1e3]:
            - img "Illustration of a fox looking at disconnected network cables." [ref=f1e5]
            - generic [ref=f1e7]:
              - heading "Server Not Found" [level=1] [ref=f1e8]
              - paragraph [ref=f1e9]:
                - text: Nightly can’t connect to the server at
                - strong [ref=f1e10]: www.google.com
              - generic [ref=f1e11]:
                - heading "What can you do about it?" [level=3] [ref=f1e12]
                - paragraph [ref=f1e13]: Try connecting on a different device. Check your modem or router. Disconnect and reconnect to Wi-Fi.
              - paragraph [ref=f1e14]:
